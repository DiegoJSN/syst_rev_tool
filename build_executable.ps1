...
& ".venv-build\Scripts\python.exe" -m PyInstaller --noconfirm --clean --onedir --noupx --console --name "SystRevTool-Demo" --add-data "templates;templates" --add-data "static;static" --exclude-module psycopg launcher.py
Write-Host ""
